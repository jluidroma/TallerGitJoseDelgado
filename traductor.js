...
function convertirUnidades(numero) {
   ...
   function convertirNumeroALetras(numero) {
     ...
     if (numero === 0) return convertirUnidades(0); // Manejo explícito del 0
     if (numero < 1000) return convertirCentenas(numero);
     if (numero < 1000000) return convertirMiles(numero);
   ...
   function convertirMilesEnIngles(numero) {
     ...
     return `${convertirCentenasEnIngles(Math.floor(numero / 1000))} thousand ${convertirCentenasEnIngles(numero % 1000)}`;
   }
   ...
   function convertirMillonesEnIngles(numero) {
     ...
     const millones = Math.floor(numero / 1000000);
     const resto = numero % 1000000;
     if (millones === 1) return `one million ${convertirMilesEnIngles(resto)}`;
     return `${convertirCentenasEnIngles(millones)} million ${convertirMilesEnIngles(resto)}`;
   }
